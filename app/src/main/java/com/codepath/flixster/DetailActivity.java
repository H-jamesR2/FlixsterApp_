...
public class DetailActivity extends YouTubeBaseActivity {
    ...
    private void initializeYoutube(final String youtubeKey, final Double movieRating) {
        youTubePlayerView.initialize(YOUTUBE_API_KEY, new YouTubePlayer.OnInitializedListener() {
            @Override
            public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean b) {
                Log.d("DetailActivity", "onInitializationSuccess");

                //When a movie has more than 5 stars
                //The movie plays immediately, else,
                //It cues an image preview of a video which can be played manually.
                if(movieRating > 5.0) {
